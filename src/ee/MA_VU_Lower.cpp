...
CMA_VU::CLower::CLower(uint32 vuMemAddressMask)
    : CMIPSInstructionFactory(MIPS_REGSIZE_32), m_vuMemAddressMask(vuMemAddressMask)
{
}
...
void CMA_VU::CLower::ApplySumSeries(size_t target, const uint32 *seriesConstants, const unsigned int *seriesExponents,
...
void CMA_VU::CLower::GenerateEATAN()
{
    ...
    static const uint32 seriesConstants[seriesLength] = {
        0x3F7FFFF5, 0xBEAAA61C, 0x3E4C40A6, 0xBE0E6C63, 0x3DC577DF, 0xBD6501C4, 0x3CB31652, 0xBB84D7E7,
    };
    static const unsigned int seriesExponents[seriesLength] = {1, 3, 5, 7, 9, 11, 13, 15};

    ApplySumSeries(offsetof(CMIPS, m_State.nCOP2T), seriesConstants, seriesExponents, seriesLength);
...
void CMA_VU::CLower::LQ()
{
    ...
    VUShared::ComputeMemAccessAddr(m_codeGen, m_nIS, static_cast<uint32>(VUShared::GetImm11Offset(m_nImm11)), 0,
                                   m_vuMemAddressMask);
    m_codeGen->AddRef();
...
void CMA_VU::CLower::SQ()
{
    ...
    // Compute address
    VUShared::ComputeMemAccessAddr(m_codeGen, m_nIT, static_cast<uint32>(VUShared::GetImm11Offset(m_nImm11)), 0,
                                   m_vuMemAddressMask);
...
void CMA_VU::CLower::ILW()
{
    ...
    // Compute address
    VUShared::ComputeMemAccessAddr(m_codeGen, m_nIS, static_cast<uint32>(VUShared::GetImm11Offset(m_nImm11)),
                                   VUShared::GetDestOffset(m_nDest), m_vuMemAddressMask);
...
void CMA_VU::CLower::ESIN()
{
    ...
    static const uint32 seriesConstants[seriesLength] = {0x3F800000, 0xBE2AAAA4, 0x3C08873E, 0xB94FB21F, 0x362E9C14};
    static const unsigned int seriesExponents[seriesLength] = {1, 3, 5, 7, 9};

    ApplySumSeries(offsetof(CMIPS, m_State.nCOP2[m_nIS].nV[m_nFSF]), seriesConstants, seriesExponents, seriesLength);
...
void CMA_VU::CLower::EEXP()
{
    ...
    static const uint32       seriesConstants[seriesLength] = {0x3E7FFFA8, 0x3D0007F4, 0x3B29D3FF,
                                                               0x3933E553, 0x36B63510, 0x353961AC};
    static const unsigned int seriesExponents[seriesLength] = {1, 2, 3, 4, 5, 6};
