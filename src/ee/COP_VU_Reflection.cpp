...
void CCOP_VU::ReflOpOff(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                        unsigned int nCount)
{
...
void CCOP_VU::ReflOpRtFd(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                         unsigned int nCount)
{
...
void CCOP_VU::ReflOpRtId(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                         unsigned int nCount)
{
    uint8 nRT = static_cast<uint8>((nOpcode >> 16) & 0x001F);
...
void CCOP_VU::ReflOpImm15(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                          unsigned int nCount)
{
...
void CCOP_VU::ReflOpAccFsFt(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                            unsigned int nCount)
{
    ...
    sprintf(sText, "ACC%s, VF%i%s, VF%i%s", m_sDestination[nDest], nFS, m_sDestination[nDest], nFT,
            m_sDestination[nDest]);
}

void CCOP_VU::ReflOpFtOffRs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                            unsigned int nCount)
{
...
void CCOP_VU::ReflOpVi27(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                         unsigned int nCount)
{
    sprintf(sText, "VI27");
}
