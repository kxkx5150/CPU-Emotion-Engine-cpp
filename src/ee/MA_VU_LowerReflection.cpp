...
void CMA_VU::CLower::ReflOpIs(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                              unsigned int count)
{
...
void CMA_VU::CLower::ReflOpIsOfs(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                 unsigned int count)
{
    uint8  is  = static_cast<uint8>((opcode >> 11) & 0x001F);
...
void CMA_VU::CLower::ReflOpIt(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                              unsigned int count)
{
...
void CMA_VU::CLower::ReflOpImm12(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                 unsigned int count)
{
...
void CMA_VU::CLower::ReflOpItImm12(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                   unsigned int count)
{
    uint8  it  = static_cast<uint8>((opcode >> 16) & 0x001F);
    uint16 imm = static_cast<uint16>((opcode & 0x7FF) | (opcode & 0x00200000) >> 10);
...
void CMA_VU::CLower::ReflOpItIs(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                unsigned int count)
{
    uint8 it = static_cast<uint8>((opcode >> 16) & 0x001F);
    uint8 is = static_cast<uint8>((opcode >> 11) & 0x001F);
...
void CMA_VU::CLower::ReflOpOfs(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                               unsigned int count)
{
    uint16 imm = static_cast<uint16>((opcode >> 0) & 0x07FF);
...
void CMA_VU::CLower::ReflOpItOfs(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                 unsigned int count)
{
    uint16 imm = static_cast<uint16>((opcode >> 0) & 0x07FF);
    uint8  it  = static_cast<uint8>((opcode >> 16) & 0x001F);
...
void CMA_VU::CLower::ReflOpItIsOfs(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                   unsigned int count)
{
    uint8  it  = static_cast<uint8>((opcode >> 16) & 0x001F);
    uint8  is  = static_cast<uint8>((opcode >> 11) & 0x001F);
...
void CMA_VU::CLower::ReflOpItIsImm15(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                     unsigned int count)
{
    uint8  it  = static_cast<uint8>((opcode >> 16) & 0x001F);
    uint8  is  = static_cast<uint8>((opcode >> 11) & 0x001F);
...
void CMA_VU::CLower::ReflOpItOfsIsDst(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                      unsigned int count)
{
...
void CMA_VU::CLower::ReflOpImm24(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                 unsigned int count)
{
...
void CMA_VU::CLower::ReflOpVi1Imm24(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                    unsigned int count)
{
    uint32 imm = opcode & 0xFFFFFF;
...
void CMA_VU::CLower::ReflOpFsDstOfsIt(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                      unsigned int count)
{
    uint8  dest = static_cast<uint8>((opcode >> 21) & 0x000F);
    uint8  it   = static_cast<uint8>((opcode >> 16) & 0x001F);
...
void CMA_VU::CLower::ReflOpFtDstOfsIs(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                      unsigned int count)
{
    uint8  dest = static_cast<uint8>((opcode >> 21) & 0x000F);
...
void CMA_VU::CLower::ReflOpFtDstFsDst(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                      unsigned int count)
{
    uint8 dest = static_cast<uint8>((opcode >> 21) & 0x000F);
    uint8 ft   = static_cast<uint8>((opcode >> 16) & 0x001F);
...
void CMA_VU::CLower::ReflOpPFs(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                               unsigned int count)
{
    uint8 fs = static_cast<uint8>((opcode >> 11) & 0x001F);
...
void CMA_VU::CLower::ReflOpPFsf(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                                unsigned int count)
{
    uint8 fs  = static_cast<uint8>((opcode >> 11) & 0x001F);
...
void CMA_VU::CLower::ReflOpFtP(INSTRUCTION *instr, CMIPS *context, uint32 address, uint32 opcode, char *text,
                               unsigned int count)
{
    uint8 dest = static_cast<uint8>((opcode >> 21) & 0x000F);
    uint8 ft   = static_cast<uint8>((opcode >> 16) & 0x001F);
...
void CMA_VU::CLower::GetInstructionMnemonic(CMIPS *context, uint32 address, uint32 opcode, char *text,
                                            unsigned int count)
{
...
void CMA_VU::CLower::GetInstructionOperands(CMIPS *context, uint32 address, uint32 opcode, char *text,
                                            unsigned int count)
{
    if (IsLOI(context, address)) {
