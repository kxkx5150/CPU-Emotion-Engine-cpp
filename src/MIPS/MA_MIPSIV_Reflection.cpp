...
void CMA_MIPSIV::ReflOpTarget(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                              unsigned int nCount)
{
...
void CMA_MIPSIV::ReflOpRtRsImm(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                               unsigned int nCount)
{
    uint8  nRS, nRT;
    uint16 nImm;
...
void CMA_MIPSIV::ReflOpRtImm(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                             unsigned int nCount)
{
    uint8  nRT;
    uint16 nImm;
...
void CMA_MIPSIV::ReflOpRsRtOff(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                               unsigned int nCount)
{
    uint8  nRS, nRT;
    uint16 nImm;
    ...
    nAddress += 4;
    sprintf(sText, "%s, %s, $%08X", CMIPS::m_sGPRName[nRS], CMIPS::m_sGPRName[nRT],
            (nAddress + CMIPS::GetBranch(nImm)));
}

void CMA_MIPSIV::ReflOpRsOff(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                             unsigned int nCount)
{
    uint8  nRS;
    uint16 nImm;
...
void CMA_MIPSIV::ReflOpRtOffRs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                               unsigned int nCount)
{
    uint8  nRS, nRT;
    uint16 nImm;
...
void CMA_MIPSIV::ReflOpHintOffRs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                                 unsigned int nCount)
{
...
void CMA_MIPSIV::ReflOpIdOffRs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                               unsigned int nCount)
{
    uint8  nRS, nRT;
    uint16 nImm;
...
void CMA_MIPSIV::ReflOpRdRsRt(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                              unsigned int nCount)
{
    uint8 nRS, nRT, nRD;
...
void CMA_MIPSIV::ReflOpRdRtSa(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                              unsigned int nCount)
{
    uint8 nSA, nRT, nRD;
...
void CMA_MIPSIV::ReflOpRdRtRs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                              unsigned int nCount)
{
    uint8 nRS, nRT, nRD;
...
void CMA_MIPSIV::ReflOpRs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                          unsigned int nCount)
{
    uint8 nRS;
...
void CMA_MIPSIV::ReflOpRd(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                          unsigned int nCount)
{
    uint8 nRD;
...
void CMA_MIPSIV::ReflOpRdRs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                            unsigned int nCount)
{
    uint8 nRS, nRD;
...
void CMA_MIPSIV::ReflOpRsRt(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                            unsigned int nCount)
{
    uint8 nRS, nRT;
...
void CMA_MIPSIV::ReflCOPOperands(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                                 unsigned int nCount)
{
    unsigned int nCOP = *(unsigned int *)&pInstr->pSubTable;
    if (pCtx->m_pCOP[nCOP] != NULL) {
