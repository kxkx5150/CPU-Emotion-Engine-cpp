...
void CCOP_SCU::ReflOpRtPcr(INSTRUCTION *instr, CMIPS *ctx, uint32 address, uint32 opcode, char *text,
                           unsigned int count)
{
    auto rt  = static_cast<uint8>((opcode >> 16) & 0x1F);
...
void CCOP_SCU::ReflOpRtRd(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                          unsigned int nCount)
{
...
void CCOP_SCU::ReflOpCcOff(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                           unsigned int nCount)
{
