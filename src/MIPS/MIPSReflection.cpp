...
void MIPSReflection::SubTableMnemonic(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nOpcode, char *sText,
                                      unsigned int nCount)
{
...
void MIPSReflection::SubTableOperands(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                                      unsigned int nCount)
{
    pInstr = DereferenceInstruction(pInstr->pSubTable, nOpcode);
