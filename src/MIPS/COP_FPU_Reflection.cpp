...
void CCOP_FPU::ReflOpRtFs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                          unsigned int nCount)
{
...
void CCOP_FPU::ReflOpRtFcs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                           unsigned int nCount)
{
    uint8 nRT = static_cast<uint8>((nOpcode >> 16) & 0x001F);
    uint8 nFS = static_cast<uint8>((nOpcode >> 11) & 0x001F);
...
void CCOP_FPU::ReflOpFdFs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                          unsigned int nCount)
{
    uint8 nFS = static_cast<uint8>((nOpcode >> 11) & 0x001F);
...
void CCOP_FPU::ReflOpFdFt(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                          unsigned int nCount)
{
...
void CCOP_FPU::ReflOpFsFt(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                          unsigned int nCount)
{
    uint8 nFS = static_cast<uint8>((nOpcode >> 11) & 0x001F);
    uint8 nFT = static_cast<uint8>((nOpcode >> 16) & 0x001F);
...
void CCOP_FPU::ReflOpCcFsFt(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                            unsigned int nCount)
{
    uint8 nFT = static_cast<uint8>((nOpcode >> 16) & 0x001F);
    uint8 nFS = static_cast<uint8>((nOpcode >> 11) & 0x001F);
...
void CCOP_FPU::ReflOpFdFsFt(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                            unsigned int nCount)
{
    uint8 nFT = static_cast<uint8>((nOpcode >> 16) & 0x001F);
    uint8 nFS = static_cast<uint8>((nOpcode >> 11) & 0x001F);
...
void CCOP_FPU::ReflOpFtOffRs(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                             unsigned int nCount)
{
...
void CCOP_FPU::ReflOpCcOff(INSTRUCTION *pInstr, CMIPS *pCtx, uint32 nAddress, uint32 nOpcode, char *sText,
                           unsigned int nCount)
{
    uint16 nImm = static_cast<uint16>((nOpcode >> 0) & 0xFFFF);
    nAddress += 4;
