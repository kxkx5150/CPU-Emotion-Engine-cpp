...
//                 return std::make_pair(std::make_shared<ISO9660::CBlockProviderCustom<0x990, 0>>(imageStream),
//                                         COpticalMedia::TRACK_DATA_TYPE_MODE1_2048);
//             case CChdImageStream::TRACK_TYPE_MODE2_RAW:
//                 return std::make_pair(std::make_shared<ISO9660::CBlockProviderCustom<0x990, 0x18>>(imageStream),
//                                         COpticalMedia::TRACK_DATA_TYPE_MODE2_2352);
//         }
//     }();
...
DiskUtils::OpticalMediaPtr DiskUtils::CreateOpticalMediaFromPath(const fs::path &imagePath,
                                                                 uint32          opticalMediaCreateFlags)
{
